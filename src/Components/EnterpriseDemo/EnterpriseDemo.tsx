...
function EnterpriseDemo() {
  return (
    <div className="mb-6 mx-auto xl:max-w-[1200px] min-[992px]:max-w-[992px] md:max-w-[720px] sm:max-w-[540px] w-full">
        {/*  */}
      <div className="max-w-[83%] mx-auto bg-violet-50 p-6 flex flex-col md:flex-row justify-between">
        <div className="flex flex-col max-md:mb-6 sm:pr-12">
          <h3 className="mb-1 text-blue-900 font-bold leading-6">Looking for Enterprise Solutions?</h3>
