  ...
  return (
    <>
      ...
      <Dialog as="div" className="relative z-10" open={open} onClose={setOpen}>
        ...
        > */}
        <div
          className={`fixed inset-0 ease-in-out bg-zinc-400 bg-opacity-75 transition-all duration-500 
        ...
        <div className="fixed inset-0 overflow-hidden">
          <div className="pointer-events-none flex fixed inset-y-0 right-0  max-w-full pl-10">
            ...
            >
              {/* menu-start */}
              <Dialog.Panel className="pointer-events-auto bg-white flex flex-col relative w-screen max-w-sm overflow-auto">
                {/* <Transition.Child
                    as={Fragment}
                    enter="ease-in-out duration-500"
                    enterFrom="opacity-0"
                      ...
                      <div className="absolute z-10 min-h-full w-full inset-y-0 right-0 transition-opacity bg-white overflow-y-scroll pr-3">
                        ...
                        <div>
                          ...
                          <div className="mt-8 flex flex-col text-[12px]">
                            ...
                            <p>
                              We've added the power of AI to even more tools.
                            </p>
...
export default PreviousMobileHeader  ;
