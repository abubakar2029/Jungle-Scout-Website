        ...
        <Dialog as="div" className="relative z-10" onClose={setOpen}>
          ...
          <div className="fixed inset-0 overflow-hidden">
            {/* <div className="absolute inset-0 overflow-hidden"> */}
              <div className="pointer-events-none flex fixed inset-y-0 right-0  bg-red-500  max-w-full pl-10">
                <Transition.Child
                  as={Fragment}
                ...
                >
                  <Dialog.Panel className="pointer-events-auto relative bg-blue-500 p-4 w-screen max-w-md">
                    <Transition.Child
                      ...
                      leaveTo="opacity-0"
                    >
                      <div className="absolute left-0 top-0 !bg-green-500 -ml-8 flex pr-2 pt-4 sm:-ml-10 sm:pr-4">
                        <button
                          type="button"
